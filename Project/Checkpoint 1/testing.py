...
# TODO: Fix miniAMR.
# rangeParams.keys()#["SWFFT", "nekbone", "miniAMR"]
enabledApps = ["ExaMiniMD", "SWFFT"]
...
def readDF():
    ...
    for app in enabledApps:
        ...
        # Use the error field whether or not we encountered an error as a training feature.
        ...
        # plt.figure()
        # plt.scatter(y_1, y, s=20, edgecolor="black", c="darkorange", label="data")
