...
def runRegressors(X, y, app=""):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=60) as executor:
        ...
        # This case takes too long. Skip it.
        if app != "ExaMiniMD poly_3":
        ...
        for i in range(1, 5+1):
            ...
            futures.append(executor.submit(regression, MLPRegressor(
                hidden_layer_sizes=layers, random_state=1, max_iter=500), str(i)+" MLP Regressor "+app, X, y))
            futures.append(executor.submit(regression, MLPRegressor(hidden_layer_sizes=layers,
                           solver="lbfgs", random_state=1, max_iter=1000), str(i)+" MLP Regressor Revised "+app, X, y))
...
def ML():
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=1) as executor:
        ...
        for app in enabledApps:
            ...
            # Run regressors.
            # Base regression. The pipeline used in checkpoint 1.
            ...
            futures.append(executor.submit(
                runRegressors, X_poly_3, y, app+" poly_3"))
